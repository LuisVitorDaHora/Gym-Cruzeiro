...
insert into matriculas (id_matricula, dt_inicio, dt_fim, status, id_aluno_fk) values
(101, '2024-08-01', '2025-08-01', 'Ativo', 1),
(102, '2022-01-30', '2025-01-30', 'Ativo', 2),
(103, '2023-09-09', '2025-09-09', 'Ativo', 3),
(104, '2024-05-10', '2025-05-10', 'Ativo', 4),
(105, '2023-10-10', '2025-10-10', 'Ativo', 5);
...
insert into aulas (id_aula, nome_aula, descricao, capacidade_maxima, data_hora, id_instrutor_fk) values
(1, 'Musculação', 'Treino focado em ganho de massa muscular.', 25, '2024-09-16 08:00:00', 1),
(2, 'Cardio Intenso', 'Treino funcional de alta intensidade.', 20, '2024-09-17 07:00:00', 2),
(3, 'Treino HIIT', 'Treino funcional de alta intensidade.', 20, '2024-09-17 09:00:00', 3);

insert into inscri_aulas (id_inscricao, dt_inscricao, id_aula_fk, id_aluno_fk) values
(101, '2024-08-01', 1, 1),
(102, '2022-01-30', 1, 2),
(103, '2023-09-09', 3, 3),
(104, '2024-05-10', 2, 4),
...
insert into equipamento (id_equipamento, nome_equipamento, descricao, dt_aquisicao, status) values
(1, 'Esteira', 'Equipamento para corrida e caminhada', '2024-01-15', 'Ativo'),
(2, 'Bicicleta Ergométrica', 'Equipamento para treino de pernas', '2024-02-20', 'Ativo'),
(3, 'Halteres', 'Conjunto de pesos para musculação', '2024-03-10', 'Ativo'),
(4, 'Barra reta', 'Equipamento para exercícios na musculação', '2024-04-05', 'Ativo'),
(5, 'Banco Scott', 'Equipamento para exercícios na musculação', '2024-05-12', 'Ativo'),
(6, 'Smitt', 'Equipamento para exercícios na musculação', '2024-05-12', 'Ativo'),
(7, 'Leg Press', 'Equipamento para exercícios na musculação', '2024-05-12', 'Ativo');

insert into avali_fisica (id_avaliacao, dt_avaliacao, peso, altura, IMC, percentual_gordura, objetivo, id_instrutor_fk) values
(1, '2024-08-01', 70, 1.75, 22.9, 15.2, 'Melhorar condicionamento físico', 1),
(2, '2024-08-02', 65, 1.60, 25.4, 18.3, 'Perder peso', 2),
(3, '2024-08-03', 80, 1.80, 24.7, 20.1, 'Aumentar massa muscular', 3);
